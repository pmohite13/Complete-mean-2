...
var AppRoutingModule = /** @class */ (function () {
    ...
    AppRoutingModule.components = [
        ...
        _customers_customer_edit_component__WEBPACK_IMPORTED_MODULE_4__["CustomerEditComponent"],
        _customers_customer_edit_reactive_component__WEBPACK_IMPORTED_MODULE_5__["CustomerEditReactiveComponent"],
        _customers_customers_grid_component__WEBPACK_IMPORTED_MODULE_3__["CustomersGridComponent"]
    ];
...
/* harmony import */ var angular_bootstrap_md__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! angular-bootstrap-md */ "./node_modules/angular-bootstrap-md/esm5/angular-bootstrap-md.es5.js");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"].components,
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getProjects = function () {
        return this.http.get(this.baseUrl)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (projects) {
    ...
    DataService.prototype.getProjectsPage = function (page, pageSize) {
        return this.http.get(this.baseProjectsUrl + "/page/" + page + "/" + pageSize, { observe: 'response' })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            //Need to observe response in order to get to this header (see {observe: 'response'} above)
            var totalRecords = +res.headers.get('x-inlinecount');
    ...
    DataService.prototype.getCitiesForState = function (stateId) {
        return this.http.get(this.baseCitiesUrl + '/' + stateId)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    };
...
/***/ "./src/app/core/register.service.ts":
/*!******************************************!*\
  !*** ./src/app/core/register.service.ts ***!
  \******************************************/
...
var RegisterService = /** @class */ (function () {
    function RegisterService(http) {
        this.http = http;
        this.baseRegisterUrl = '/api/auth/register';
        this.baseLoginUrl = '/api/auth/login';
    }
    ...
    RegisterService.prototype.loginUser = function (user) {
        return this.http.post(this.baseLoginUrl, user)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (authResponse) {
            console.log('registration success: ');
            return authResponse;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    };
